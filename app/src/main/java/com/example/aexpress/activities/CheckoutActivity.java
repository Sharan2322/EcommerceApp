...
public class CheckoutActivity extends AppCompatActivity {
    ...
    void  processOrder(){
        ...
        try {
            productOrder.put("address",binding.addressBox4.getText().toString());
            productOrder.put("buyer",binding.nameBox.getText().toString());
            productOrder.put("comment",binding.commentBox6.getText().toString());
            ...
            productOrder.put("email",binding.emailBox2.getText().toString());
            productOrder.put("phone",binding.phoneBox3.getText().toString());
